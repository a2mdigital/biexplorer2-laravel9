...
@csrf 
<input type="hidden" name="id_playlist" id="id_playlist" value="">
<div class="row">
            ...
            <div class="row">
              <div class="col-sm-3">
                <div class="form-group {{$errors->has('nome') ? 'has-danger' : ''}}">
                  ...
                  <input type="text" value="{{old('nome')}}" class="form-control {{$errors->has('nome') ? 'form-control-danger' : ''}}" name="nome" placeholder="Nome">
                  @if($errors->has('nome'))
              ...
              <div class="col-sm-4">
                <div class="form-group {{$errors->has('tempo_atualizacao') ? 'has-danger' : ''}}">
                  ...
                  <input type="number" value="{{old('tempo_atualizacao')}}" class="form-control {{$errors->has('tempo_atualizacao') ? 'form-control-danger' : ''}}" name="tempo_atualizacao" placeholder="EX:10">
  ...
  $("#relatorio").on("change", function () {
      ...
      $(document).on('click', '.adicionarRelPlaylist', function () {
       ...
       if(tipo == 'relatorio'){
           ...
           var navegacao = "<br> <input type='checkbox' disabled class='form-group'><del><i>Navegar entre páginas</i></del><input hidden id='navega_paginas' name='itensplaylist[navega_paginas][]' value='N'/>"
       }

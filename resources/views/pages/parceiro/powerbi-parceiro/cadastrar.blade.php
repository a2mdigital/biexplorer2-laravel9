...
<nav class="page-breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="{{route('parceiro.powerbi')}}">Power Bi</a></li>
    <li class="breadcrumb-item active" aria-current="page">Cadastrar Conta</li>
  </ol>
</nav>
<div class="row">
    ...
    <div class="card">
      <div class="card-body">
        <h6 class="card-title">Cadastro de Conta Power Bi</h6>
          <form method="POST" action="{{route('parceiro.powerbi.salvar')}}">
          @csrf 
            <div class="row">
              <div class="col-sm-5">
                <div class="form-group {{$errors->has('user_powerbi') ? 'has-danger' : ''}}">
                  <label class="control-label">Usuário</label>
                  <input type="text" value="{{old('user_powerbi')}}" class="form-control {{$errors->has('user_powerbi') ? 'form-control-danger' : ''}}" name="user_powerbi" placeholder="Usuário Power BI">
              ...
              <div class="col-sm-5">
                <div class="form-group {{$errors->has('password_powerbi') ? 'has-danger' : ''}}">
                  ...
                  <input type="password" value="{{old('password_powerbi')}}" class="form-control {{$errors->has('password_powerbi') ? 'form-control-danger' : ''}}" name="password_powerbi" placeholder="Senha">
            ...
            <div class="col-sm-4">
                <div class="form-group {{$errors->has('client_id') ? 'has-danger' : ''}}">
                  ...
                  <input type="text" value="{{old('client_id')}}" class="form-control {{$errors->has('client_id') ? 'form-control-danger' : ''}}" name="client_id" placeholder="Client ID">
              ...
              <div class="col-sm-4">
                <div class="form-group {{$errors->has('client_secret') ? 'has-danger' : ''}}">
                  ...
                  <input type="text" value="{{old('client_secret')}}" class="form-control {{$errors->has('client_secret') ? 'form-control-danger' : ''}}" name="client_secret" placeholder="Client Secret">
              ...
              <div class="col-sm-4">
                <div class="form-group {{$errors->has('diretorio_id') ? 'has-danger' : ''}}">
                  ...
                  <input type="text" value="{{old('diretorio_id')}}" class="form-control {{$errors->has('diretorio_id') ? 'form-control-danger' : ''}}" name="diretorio_id" placeholder="Diretório ID">

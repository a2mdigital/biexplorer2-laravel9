...
class CreateDepartamentoRelatorioTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('departamento_relatorio', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('departamento_relatorio');
    }
}
